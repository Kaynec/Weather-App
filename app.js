    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 21:
            _context.next = 23;
            return close.addEventListener('touchend', function () {
              document.querySelector('#container').removeChild(grid);
            });
...
app_button.addEventListener('touchend', function (e) {
  return sendDataToDom(e);
});
